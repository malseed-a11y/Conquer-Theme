        ...
        <div class="meta mb-3">
            ...
            <span class="date">
                ...
                foreach ($cat_list as $cat) {
                    if (isset($cat->name)) {
                        if ($i == 0) {
                            echo '<span class="category"><i class="fa fa-tag"></i> ' . esc_html($cat->name) .
                                '</span>';
                        } else {
                            echo ', <span class="category"><i class="fa fa-tag"></i> ' . esc_html($cat->name) . ' , ' . '</span>';
                        }
                    }
                    $i++;
                }
                ...
                foreach ($term_list as $term) {
                    if (isset($term->name)) {
                        if ($i == 0) {
                            echo '<span class="tag"><i class="fa fa-tag"></i> ' . esc_html($term->name) . '</span>';
                        } else {
                            echo ', <span class="tag"><i class="fa fa-tag"></i> ' . esc_html($term->name) . '</span>';
                        }
                    }
